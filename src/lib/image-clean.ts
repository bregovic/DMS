 ...
 *
 * 1) najde papír na fotce (světlá plocha proti pozadí), ořízne ho a narovná,
 * 2) převede do šedé, roztáhne kontrast podle histogramu a jemně doostří,
 * 3) uloží jako JPEG v rozumném rozlišení.
 *
 * Fotka účtenky z telefonu má 3–8 MB, po úpravě kolem 200 kB a text je
 * čitelnější. Když si detekcí nejsme jistí, ořez se vynechá; když by výsledek
 * vyšel větší než originál, vrátí se původní soubor.
 */
...
/** Jen vyčištění bez ořezu (zpětně kompatibilní). */
