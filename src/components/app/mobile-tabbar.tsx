...
export function MobileTabBar() {
  ...
  return (
    ...
    <nav className="fixed inset-x-0 bottom-0 z-40 flex print:!hidden border-t border-stone-200 bg-white/95 pb-[env(safe-area-inset-bottom)] backdrop-blur md:hidden">
