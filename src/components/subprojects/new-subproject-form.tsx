...
export function NewSubProjectForm({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start justify-center overflow-y-auto bg-stone-950/30 p-4 py-16">
      <div className="w-full max-w-md border border-stone-300 bg-white shadow-lift">
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-1.5">
              <Label htmlFor="deadline">Termín (volitelné)</Label>
